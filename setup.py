...
setup(
    ...
    description="python runner for SAS Enterprise Gide file",  # Optional
    ...
    url="https://github.com/kjnh10/saseg_runner",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="kjnh10",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="kojinho10@gmail.com",  # Optional
    ...
    keywords="python egp sas enterprise guide",  # Optional
